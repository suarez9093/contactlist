...
module.exports = function(app) {
    ...
    app.get("/", function(req, res) {
        db.Contact.findAll({
            ...
            // res.json(contacts);
            res.render("contacts", {contacts, name: "Alex", day: "Friday"})
        })
    });
    ...
    app.get("/:type", function(req, res) {
        let type = req.params.type[0].toUpperCase() + req.params.type.substring(1);
        db.Contact.findAll({
            where: {
            ...
            console.log(contacts);
            // res.json(contacts);
            res.render("contacts", {contacts, type,  name: "Alex", })
        })
